...
const T = {
  en: {
    ...
    'booking.sub':    'Select a service or specialist, then complete your booking on Bokadirekt.',
    ...
    'step3.redirect': 'Your selection is ready. Continue on Bokadirekt to choose your date and time.',
    'step3.redirectNote': 'A new tab opened automatically. Click above if it was blocked by your browser.',
    'no.avail':       'No specialist is currently available for this service. Please contact us directly.',
    'btn.back':       'Back',
    'btn.continue':   'Continue',
    'btn.openBokadirekt': 'Open Bokadirekt',
  ...
  sv: {
    ...
    'booking.sub':    'Välj en tjänst eller specialist, slutför sedan din bokning på Bokadirekt.',
    ...
    'step3.redirect': 'Ditt val är klart. Fortsätt på Bokadirekt för att välja datum och tid.',
    'step3.redirectNote': 'En ny flik öppnades automatiskt. Klicka ovan om den blockerades.',
    'no.avail':       'Ingen specialist finns för denna tjänst. Kontakta oss direkt.',
    'btn.back':       'Tillbaka',
    'btn.continue':   'Fortsätt',
    'btn.openBokadirekt': 'Öppna Bokadirekt',
